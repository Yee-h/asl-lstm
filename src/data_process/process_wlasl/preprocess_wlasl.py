...
使用方法：
    python preprocess_wlasl.py                     # 处理完整数据集（WLASL2000+）
    python preprocess_wlasl.py --subset 100        # 处理 WLASL100 子集
    python preprocess_wlasl.py --subset 300        # 处理 WLASL300 子集
    python preprocess_wlasl.py --subset 2000       # 处理 WLASL2000 子集
    python preprocess_wlasl.py --limit 50          # 只处理前 50 个视频（用于测试）
    python preprocess_wlasl.py --json my_data.json # 使用自定义 JSON 文件
"""
...
# 输入输出路径配置
DEFAULT_JSON_PATH = "WLASL_v0.3.json"
