...
| | Seed=456 + TM | **74.42** | **91.86** |
| | Seed=789 + TM | **74.81** | **92.25** |
| | **TM 平均** | **74.13 (+6.75%)** | - |
| **架构变体** | + LayerNorm (E04) | 70.16 | 91.47 |
| | + MultiHead k=4 (E06) | 72.09 | 89.92 |
| | Hidden=192 (E07a) | 71.71 | 91.47 |
| | + Accel 6ch (E08) | 71.71 | 91.47 |
| | + LR Warmup (E03) | 65.89 | 89.92 |
| **模型集成** | **4-Model Ensemble (Softmax Avg)** | **75.97** | **94.57** |
